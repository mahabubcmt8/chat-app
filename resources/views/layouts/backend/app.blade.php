...
<html lang="en">
  <head>
    ...
    <!-- CSS files -->
    <link href="{{ asset('backend/libs/jqvmap/dist/jqvmap.min.css') }}" rel="stylesheet"/>
  ...
  <body class="antialiased">
    ...
    <script src="{{ asset('backend/libs/jquery/dist/jquery.slim.min.js') }}./dist"></script>
    <script src="{{ asset('backend/libs/apexcharts/dist/apexcharts.min.js') }}."></script>
    <script src="{{ asset('backend/libs/jqvmap/dist/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('backend/libs/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
    <script src="{{ asset('backend/libs/peity/jquery.peity.min.js') }}"></script>
    <!-- Tabler Core -->
    <script src="{{ asset('backend/js/tabler.min.js') }}"></script>
    <script>
      // @formatter:off
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-15').text("17, 24, 20, 10, 5, 1, 4, 18, 13").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-16').text("13, 11, 19, 22, 12, 7, 14, 3, 21").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-17').text("10, 13, 10, 4, 17, 3, 23, 22, 19").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-18').text("9, 6, 14, 11, 8, 24, 2, 16, 15").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
